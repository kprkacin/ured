...
export const Footer: React.FC = ({ children }) => {
  return (
    <div className="w-full mb-10 bg-white">
      <div className=" after:w-full after:m-auto after:block after:col-span-3 after:border-b after:border-b-1-black">
        <div className="container grid items-start w-full grid-cols-3 gap-6 px-6 pt-10 mx-auto mb-10 ">
          <div className="w-full col-span-full md:col-span-1 md:w-full lg:w-1/2 lg:col-span-1">
          ...
          <div className="col-span-full md:col-span-2 lg:col-span-1">
            <p className="font-semibold text-gray-500">
              ...
              savjetovanje. Kao moderan ured svakodnevno i kontinuirano
              proširuju područja pravne pomoći i spektar pružanja pravnih
              usluga.
            </p>
          </div>
      ...
      <div className="w-full text-right">
        <Link href="/privacy">
          <a className="mr-5 text-sm align text-gold">
            Provjerite našu policu privatnosti
          </a>
        </Link>
      </div>
    </div>
