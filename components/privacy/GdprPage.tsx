...
export const GDPRPage: React.FC = ({ children }) => {
  return (
    <div className="py-16 mx-auto text-white ">
      <h1 className="h-full my-5 text-2xl semibold text-gold">
        Privacy Policy of cali corp
      </h1>
      <p>
        cali corp operates the name.com website, which provides the SERVICE.
      </p>
      <p>
        This page is used to inform website visitors regarding our policies with
        the collection, use, and disclosure of Personal Information if anyone
        decided to use our Service, the name website.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at name.com, unless otherwise
        defined in this Privacy Policy.
      </p>
      <h2 className="h-full my-4 text-xl semibold text-gold">
      ...
      <h2 className="h-full my-4 text-xl semibold text-gold">Log Data</h2>
      <p>
      ...
      <h2 className="h-full my-4 text-xl semibold text-gold">Cookies</h2>
      <p>
      ...
      <h2 className="h-full my-4 text-xl semibold text-gold">Security</h2>
      <p>
      ...
      <h2 className="h-full my-4 text-xl semibold text-gold">Contact Us</h2>
      <p>
